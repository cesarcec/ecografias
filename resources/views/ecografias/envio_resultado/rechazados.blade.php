    ...
    <div class="card">
        <div class="card-header pointer-cursor" data-toggle="collapse" data-target="#collapse-form" aria-expanded="false"
            ...
            <div class="d-flex justify-content-between">
                <h3 class="my-2 mx-2">Envíos Rechazados</h1>
            </div>
        </div>
    </div>
                ...
                <table id="table" class="table table-striped">
                    ...
                    <tbody>
                        @foreach ($envioResultados as $envioResultado)
                            <tr class=" bg-danger">
                                <th class=" text-white" scope="row">{{ $envioResultado->id }}</th>

                                <td class=" text-white">{{ $envioResultado->fecha }}</td>

                                <td class=" text-white">{{ $envioResultado->estado_envio }}</td>
                                <td class=" text-white">
