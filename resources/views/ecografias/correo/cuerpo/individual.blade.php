...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>
                <strong>Data:</strong> {{ $data['mensaje'] }}
            </p>
            <p>
        ...
        <div class="footer">
            ...
            <p>Este correo electrónico fue enviado a usted como parte de nuestra comunidad de CEDISA. Si no desea recibir más correos, por favor, <a href="https://example.com/unsubscribe" style="color: #007bff;">darse de baja aquí</a>.</p>
        </div>
    </div>
</body>
</html>
